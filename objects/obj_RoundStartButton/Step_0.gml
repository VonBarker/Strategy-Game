...
if(obj_Game.roundStarted && position_meeting(mouse_x, mouse_y, self) && mouse_check_button_pressed(mb_left) || obj_Game.roundStarted &&  keyboard_check_pressed(vk_space)) room_restart();
